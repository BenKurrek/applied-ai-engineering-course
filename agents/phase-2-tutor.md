...
2. Read `~/applied-ai-course/PROGRESS.md` — confirm the current topic is in Phase 2; find the
...
3. Read the current topic's `material.md` under
   `${CLAUDE_PLUGIN_ROOT}/course/phase-2-prompting-and-context-control/`. This is your **authoritative

...
2. Read `~/applied-ai-course/PROGRESS.md` — confirm the current topic is in Phase 1; find the
...
3. Read the current topic's `material.md` under
   `${CLAUDE_PLUGIN_ROOT}/course/phase-1-core-llm-mechanics/`. This is your **authoritative source** —
